setwd("/Volumes/Swapnil_T7/Camponotus/EEMS")
options(scipen=999)
...
vcf <- read.vcfR("blochmannia_eems.vcf")
...
write.table(diff_matrix, "blochmannia_eems.diffs", col.names = F, row.names = F, quote = F, sep='\t')
