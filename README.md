...
6. Run "03_camplaevi_filter.sh" to filter SNPs for downstream analyses. This script includes filtering scheme for all downstream analyses.


# Blochmannia pipeline (endosymbiont)
