...
header <- paste('\tgunzip -cd ', project_directory, '/scaffold0001.recode.vcf.gz | grep "#" > ', project_directory, "/windows/${chrom_array}__${start_array}__${end_array}.recode.vcf", sep="")
